...
with open('1_VAR_Data_Extraction.ipynb', 'r') as f:
    notebook = json.load(f)

# Enhanced cells for Data Extraction notebook
extraction_cells = [
    {
        "cell_type": "markdown",
        "metadata": {},
...
notebook['cells'] = base_cells + extraction_cells

# Write the enhanced notebook back to file
with open('1_VAR_Data_Extraction.ipynb', 'w') as f:
    json.dump(notebook, f, indent=2)

print("✅ Enhanced the Data Extraction notebook with more extensive code!") 